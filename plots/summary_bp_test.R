...
# ---- Summarise ---------------------------------------------------------------
model_levels <- c("Bayesian_PROCOVA - 0.005","Bayesian_PROCOVA - 0.001","Bayesian_PROCOVA - 0.01",
                  "Bayesian_PROCOVA - 0.05","Bayesian_PROCOVA - JAGS - 0.005",
                  "Bayesian_PROCOVA - JAGS - 0.01")
